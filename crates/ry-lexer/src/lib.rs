...
//
// Lexer zero-copy con lifetimes para Ry-Dit.
...
///
/// ```
/// let tokens = ry_lexer::scan("shield.init dark.slot x = 100");
/// assert!(tokens.iter().any(|t| t.kind == ry_lexer::TokenKind::ShieldInit));
/// ```
